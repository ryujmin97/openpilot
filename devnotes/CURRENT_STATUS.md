...
- carrot-ryu HEAD: `ba929b5f29cf88530f2fd64e28b5fc59f12e4c8b` (86차, 항목22/23/26 push 확인 + 항목24(41차) 재적용). carrot-ryu-v1(`9ccf1206a034c5fb5e5f35201553f9fc4e5237e5`)에 원래 36개 항목 전체가 보존됨. 실기기 배포/검증은 미실시(git pull 금지 유지 중). **[87차, 정정]** 이 줄이 82차/83차 기준(`435d0b58`)으로 오래 방치돼 있던 것을 16절에 따라 발견/정정(코드 변경 아님) -- 그 사이 항목 20·21(80~83차)·22·23·24·26(85~86차)까지 전부 push 완료됨. **Google Drive 파이프라인(항목 5~10·12·17·18·20·21) + 항목 22·23·24·26까지 전부 이식 완료.** 남은 건 항목 30~36(스크린샷 캡처 체인)뿐이며, 87차에서 반영 스크립트 작성까지 완료, 실행/push 대기(아래 87차 항목 참고).
