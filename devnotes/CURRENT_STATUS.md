...
- carrot-ryu HEAD: `25f21d406d23bfb79ad45a67890cc39e3ad9e67b` (93차, carrot-ms 557e6f6a 재적용 -- 부모 `9eced40`(92차, ec95363a), 그 부모 `f1e920d`(91차 계속2, 4d1a3ded), 그 부모 `260565f`(90차, b4f751f4). 4건 모두 GitHub push 확인 완료. carrot-ryu-v1(`9ccf1206a034c5fb5e5f35201553f9fc4e5237e5`)에 원래 36개 항목 전체가 보존됨. 실기기 배포/검증은 미실시(git pull 금지 유지 중). **36개 항목(1~36) 전부 GitHub 반영 확인 완료.**
