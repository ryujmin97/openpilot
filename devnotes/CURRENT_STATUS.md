...
- carrot-ryu HEAD: 34bb41bc (30차, 경로안내 박스 route=/도착 텍스트 위치 재조정, GitHub 커밋 로그 직접 재조회로 확인)
...
- gdrive_upload.py: OAuth2 Device Authorization Grant + resumable 업로드(8MB 청크). 고정 DRIVE_FOLDER_ID 사용(폴더 자동생성 안 함).
