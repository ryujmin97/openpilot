...
- carrot-ryu HEAD: `9eced40e12dba9ecaa71fe4bd25a812d39d956ce` (92차, carrot-ms ec95363a 재적용 -- 부모 `f1e920d`(91차 계속2, 4d1a3ded 재적용), 그 부모 `260565f`(90차, b4f751f4 재적용). 93차 시점 557e6f6a 반영 스크립트는 작성됨(실행/push 대기, 이 HEAD는 그 push 전 기준). carrot-ryu-v1(`9ccf1206a034c5fb5e5f35201553f9fc4e5237e5`)에 원래 36개 항목 전체가 보존됨. 실기기 배포/검증은 미실시(git pull 금지 유지 중). **36개 항목(1~36) 전부 GitHub 반영 확인 완료.**
